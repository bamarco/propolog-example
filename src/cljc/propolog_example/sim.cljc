(ns propolog-example.sim
  (:require [taoensso.timbre :as log]
            ...
            [propolog-example.control :as control]
...
(def control-catalog
  '[{:control/type :indicator
     ...
     :control/show? (:propolog-example.control/control-attr :onyx.sim/next-action? :control/toggled?)
     :control/display (:propolog-example.sim/next-action-actual)}
    {:control/type :choice
     :control/name :onyx.sim/nav
     :control/label "Navigation"
     :control/chosen (:propolog-example.sim/selected-nav)
     :control/choose (:propolog-example.sim/select-view)
     :control/choices (:propolog-example.sim/view-choices)}
    {:control/type :active-logo
     :control/name :onyx.sim/logo
     :control/label "nyx-sim (alpha)"
     :control/img "onyx-logo.png"
     :control/active? (:propolog-example.sim/any-running?)}
    {:control/type :indicator
     :control/name :onyx.sim/description
     :control/label "Description"
     :control/show? (:propolog-example.control/control-attr :onyx.sim/description? :control/toggled?)
     :control/display (:propolog-example.sim/description-actual)}
    {:control/type :toggle
     :control/name :onyx.sim/description?
     :control/label "Show Description"
     :control/toggle (:propolog-example.control/simple-toggle :onyx.sim/description?)
     :control/toggled? false}
    {:control/type :toggle
     :control/name :onyx.sim/next-action?
     :control/label "Show Next Action"
     :control/toggle (:propolog-example.control/simple-toggle :onyx.sim/next-action?)
    ...
    {:control/type :choice
     ...
     :control/choose (:propolog-example.control/simple-choose-one :onyx.sim/env-display-style)
    ...
    {:control/type :toggle
     ...
     :control/toggle (:propolog-example.control/simple-toggle :onyx.sim/render-segments?)
     :control/disabled? (:propolog-example.control/simple-not-chosen? :onyx.sim/env-display-style :pretty-env)
     :control/toggled? true}
    {:control/type :toggle
     :control/name :onyx.sim/only-summary?
     :control/label "(Only Summary)"
     :control/toggle (:propolog-example.control/simple-toggle :onyx.sim/only-summary?)
     :control/disabled? (:propolog-example.control/simple-not-chosen? :onyx.sim/env-display-style :raw-env)
     :control/toggled? true}
    {:control/type :action
     :control/name :onyx.api/tick
     :control/label "Tick"
     :control/action (:propolog-example.sim/tick)
     :control/disabled? (:propolog-example.sim/running?)}
    {:control/type :action
     :control/name :onyx.api/step
     :control/label "Step"
     :control/action (:propolog-example.sim/step)
     :control/disabled? (:propolog-example.sim/running?)}
    {:control/type :action
     :control/name :onyx.api/drain
     :control/label "Drain"
     :control/action (:propolog-example.sim/drain)
     :control/disabled? (:propolog-example.sim/running?)}
    {:control/type :toggle
     :control/name :onyx.sim/play
     :control/label "Play"
     :control/toggle-label "Pause"
     :control/toggled? (:propolog-example.sim/running?)
     :control/toggle (:propolog-example.sim/toggle-play)}
    {:control/type :choice
     :control/name :onyx.sim/hidden-tasks
     :control/label "Hidden Tasks"
     :control/chosen (:propolog-example.sim/hidden-tasks)
     :control/choose (:propolog-example.sim/hide-tasks)
     :control/choices (:propolog-example.sim/sorted-tasks)
...
(defn sim-view [conn]
  [flui/v-box
   ...
   [[control/selection-list conn :onyx.sim/hidden-tasks]
    [control/when-show? [control/indicator-display conn :onyx.sim/description]]
    [action-box conn]
    [control/when-show? [control/indicator-label conn :onyx.sim/next-action]]
